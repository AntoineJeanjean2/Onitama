...
public class Pioche {
    ...
    public Pioche()  {                    // Le déplacement est donc définit par un couple (déplacement sur lignes, déplacement sur colonnes)
                                          //L'axe des lignes est donc croissant de haut en bas et l'axe des colonnes croissant de gauche à droite
    ...
    public void melangerPioche(Carte [] cartePioche) { // On mélange la pioche en effectuant 20 échanges de positions entre deux cartes sélectionnées aléatoirement
        for (int i=0; i<20;i++){
